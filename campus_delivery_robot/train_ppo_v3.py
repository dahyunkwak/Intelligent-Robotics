...
CFG = dict(
    ...
    log_dir         = "./ppo_campus_log_v3/",
    ckpt_dir        = "./checkpoints_v3/",
    model_path      = "ppo_campus_robot_v3",
    vecnorm_path    = "ppo_campus_vecnormalize_v3.pkl",
)
...
def main():
    print("🌏 환경 v3 초기화 중... (충전소: 맵 북서쪽 외딴 곳)")
    ...
    print(f"🚀 강화학습 v3 시작 (총 {CFG['total_timesteps']:,} 스텝)")
